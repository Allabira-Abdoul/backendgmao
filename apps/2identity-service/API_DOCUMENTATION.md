...
## ðŸ“¡ Endpoints Specification

### ðŸŸ¢ Get Current User Profile (Authenticated)
...
### ðŸŸ¢ Change Password (Authenticated)
...
### ðŸŸ¢ List Users (Privilege: `USER_VIEW`)
...
### ðŸŸ¢ Get Specific User (Privilege: `USER_VIEW` or Self)
...
### ðŸŸ¢ Create User (Privilege: `USER_CREATE`)
...
### ðŸŸ¢ Update User (Privilege: `USER_UPDATE`)
...
### ðŸŸ¢ Admin Reset Password (Privilege: `USER_UPDATE`)
...
### ðŸŸ¢ Delete User (Privilege: `USER_DELETE`)
...
## ðŸ‘¥ Dynamic Role Management Endpoints

### ðŸŸ¢ List Roles (Privilege: `ROLE_VIEW`)
- **HTTP Method**: `GET`
- **Path**: `/api/user/roles`

### ðŸŸ¢ Get Specific Role (Privilege: `ROLE_VIEW`)
- **HTTP Method**: `GET`
- **Path**: `/api/user/roles/:id`

### ðŸŸ¢ Create Role (Privilege: `ROLE_CREATE`)
- **HTTP Method**: `POST`
- **Path**: `/api/user/roles`
- **Request Body**:
```json
...
### ðŸŸ¢ Update Role (Privilege: `ROLE_UPDATE`)
- **HTTP Method**: `PUT`
- **Path**: `/api/user/roles/:id`

### ðŸŸ¢ Delete Role (Privilege: `ROLE_DELETE`)
- **HTTP Method**: `DELETE`
- **Path**: `/api/user/roles/:id`
...
### ðŸŸ¢ Set Role Privileges (Privilege: `ROLE_UPDATE`)
- **HTTP Method**: `PUT`
...
### ðŸŸ¢ Get System Privileges List (Privilege: `SYSTEM_CONFIG` or `SYSTEM_ADMIN`)
...
## ðŸ—ï¸ Team Management Endpoints

### ðŸŸ¢ List Teams (Privilege: `TEAM_VIEW`)
- **HTTP Method**: `GET`
- **Path**: `/api/user/teams`

### ðŸŸ¢ Get Specific Team (Privilege: `TEAM_VIEW`)
- **HTTP Method**: `GET`
...
### ðŸŸ¢ Create Team (Privilege: `TEAM_CREATE`)
- **HTTP Method**: `POST`
- **Path**: `/api/user/teams`
- **Request Body**:
```json
...
### ðŸŸ¢ Update Team (Privilege: `TEAM_UPDATE`)
- **HTTP Method**: `PUT`
- **Path**: `/api/user/teams/:id`
- **Request Body**:
```json
...
### ðŸŸ¢ Delete Team (Privilege: `TEAM_DELETE`)
- **HTTP Method**: `DELETE`
- **Path**: `/api/user/teams/:id`
...
## ðŸ”’ Internal Service-to-Service Endpoints
